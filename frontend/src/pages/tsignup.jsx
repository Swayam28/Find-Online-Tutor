...
function Tsignup(){
    ...
    const [qualificationReg,setQualificationReg]=useState('')
    ...
    const tregister=()=>{
      Axios.post("http://localhost:3001/tregister", {
        ...
        Qualification: qualificationReg,
      }).then((response)=>{
  ...
  return(
    <div className="obox">
      <div>
        ...
        <input type="text" className="inpbox" placeholder="Qualification" onChange={(e)=>{
            setQualificationReg(e.target.value);
        }}/>   <br/>
